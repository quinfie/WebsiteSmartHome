...
export { default as User } from "./UsersPage";
export { default as Profile } from "./Profile";
export { default as Login } from "./Login";
export { default as Register } from "./Register";
export { default as ChangePassword } from "./ChangePassword";
export { default as Product } from "./SanPhamPage";
export { default as Order } from "./DonHangPage";
export { default as Category } from "./DanhMucPage";
export { default as Review } from "./DanhGiaPage";
export { default as Promotion } from "./KhuyenMaiPage";
export { default as RequestService } from "./YeuCauDichVuPage";
