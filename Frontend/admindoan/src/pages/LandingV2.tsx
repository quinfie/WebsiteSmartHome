    ...
    <div className="h-auto border-t dark:border-blackSecondary border-blackSecondary border-1 flex dark:bg-blackPrimary bg-whiteSecondary">
      ...
      <div className="dark:bg-blackPrimary bg-whiteSecondary w-full pt-6 pl-9 max-sm:pt-6 max-sm:pl-1">
        ...
        <div className="flex flex-wrap justify-between gap-5 px-5 w-[95%]">
          <SingleStatsV2>
            <SingleStatsV2.StatsCategory statsCategory="Lợi nhuận">
              <HiCurrencyDollar className="text-2xl" />
            </SingleStatsV2.StatsCategory>
            <SingleStatsV2.MoneyStats moneyAmount="812.650.500">
          ...
          <SingleStatsV2>
            <SingleStatsV2.StatsCategory statsCategory="Chi tiêu">
              <HiShoppingCart className="text-2xl" />
            </SingleStatsV2.StatsCategory>
            <SingleStatsV2.MoneyStats moneyAmount="159.000.000">
          ...
          <SingleStatsV2>
            <SingleStatsV2.StatsCategory statsCategory="Doanh thu">
              <HiCurrencyDollar className="text-2xl" />
            </SingleStatsV2.StatsCategory>
            <SingleStatsV2.MoneyStats moneyAmount="12.400.755">
              <p className="text-white dark:bg-green-700 bg-green-500 w-20 h-10 flex gap-1 items-center justify-center font-semibold">
                <HiArrowSmallUp className="text-blackPrimary text-xl" />{" "}
                <span>15.1%</span>
              </p>
          ...
          <SingleStatsV2>
            <SingleStatsV2.StatsCategory statsCategory="Người dùng mới">
